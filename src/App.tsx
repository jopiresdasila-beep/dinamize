    ...
    <div className="relative w-full min-h-screen font-sans">
      ...
      <div className="relative w-full h-full z-0 bg-white">
        ...
        <section className="relative w-full flex flex-col bg-[#021c91] overflow-hidden">
          ...
          <div className="absolute z-50 bottom-[48%] sm:bottom-[52%] md:bottom-[8%] lg:bottom-[10%] xl:bottom-[12%] left-1/2 -translate-x-1/2 md:translate-x-0 md:left-[5%] lg:left-[5%] xl:left-[8%] w-auto flex justify-center md:justify-start">
            <a
              id="whatsapp-button-hero"
              ...
              className="px-4 sm:px-8 bg-[#25D366] hover:bg-[#20bd5a] text-white font-bold text-[13px] sm:text-base md:text-xl py-3 sm:py-4 md:py-5 rounded-xl shadow-[0_0_20px_rgba(37,211,102,0.3)] hover:shadow-[0_0_40px_rgba(37,211,102,0.6)] transition-all duration-300 transform hover:-translate-y-1 uppercase tracking-wider flex items-center justify-center gap-2 sm:gap-3 cursor-pointer whitespace-nowrap"
            >
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 shrink-0">
          ...
          <div className="relative z-10 max-w-4xl w-full text-center flex flex-col items-center">
            ...
            <form onSubmit={handleFormSubmit} className="w-full max-w-md flex flex-col gap-4">
              ...
              <a 
                ...
                onClick={() => {
                  if (typeof window !== 'undefined' && (window as any).fbq) {
                    (window as any).fbq('track', 'Contact', { content_name: 'WhatsApp_Footer' });
                  }
                }}
